...
const meta = {
  ...
  parameters: {
    docs: {story: {inline: false, height: '380px'}, description: {component: 'A plain press in a stack header’s trailing slot: `HeaderMenu` without the menu, at the platform’s header size and in the same host. The stories put it in a real header, which is what it reads its focus and its metrics from.'}},
