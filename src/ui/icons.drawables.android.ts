...
import audio_file from '@expo/material-symbols/audio_file.xml';
import calendar_month from '@expo/material-symbols/calendar_month.xml';
import check_circle from '@expo/material-symbols/check_circle.xml';
