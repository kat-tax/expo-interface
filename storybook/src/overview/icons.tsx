...
/** Small inline glyphs for the Overview header: platform badges and links. */
...
export function ArrowRightIcon(props: IconProps) {
  return (
    <svg {...base} width={20} height={20} fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" role="img" {...props}>
